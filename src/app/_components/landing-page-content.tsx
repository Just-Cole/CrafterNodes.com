                        ...
                        <div className="mt-10 flex items-center justify-center gap-x-4">
                            ...
                            <Button size="lg" variant="outline" className="text-white border-white hover:bg-white hover:text-black" asChild>
                                <Link href="https://discord.gg/your-invite" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="mr-2 h-5 w-5"><path d="M19.54 6.04c-1.63-1.63-3.83-2.68-6.18-2.92-0.03-0.1-0.07-0.2-0.12-0.3-0.4-0.54-0.85-1.01-1.37-1.39-0.42-0.31-0.85-0.55-1.28-0.61-0.02 0-0.03-0.01-0.05-0.01-0.13-0.02-0.26-0.03-0.39-0.03s-0.26 0.01-0.39 0.03c-0.02 0-0.03 0.01-0.05 0.01-0.43 0.06-0.86 0.3-1.28 0.61-0.52 0.38-0.97 0.85-1.37 1.39-0.05 0.1-0.09 0.2-0.12 0.3-2.35 0.24-4.55 1.29-6.18 2.92C-0.01 7.89-0.18 12.44 2.05 16.01c1.37 2.21 3.52 3.82 5.91 4.79 0.53 0.21 1.08 0.37 1.63 0.49 0.49 0.11 1 0.17 1.5 0.17s1.01-0.06 1.5-0.17c0.55-0.12 1.1-0.28 1.63-0.49 2.39-0.97 4.54-2.58 5.91-4.79 2.23-3.57 2.06-8.12 0.46-9.97zM10.13 14.86c-0.83 0-1.51-0.74-1.51-1.65s0.68-1.65 1.51-1.65c0.84 0 1.51 0.74 1.51 1.65 0 0.91-0.67 1.65-1.51 1.65zM14.86 14.86c-0.83 0-1.51-0.74-1.51-1.65s0.68-1.65 1.51-1.65c0.84 0 1.51 0.74 1.51 1.65 0 0.91-0.67 1.65-1.51 1.65z"></path></svg>
                                    Join Discord
                                </Link>
                            </Button>
                        </div>
